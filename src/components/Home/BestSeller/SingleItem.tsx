  ...
  return (
    <div className="group">
      <div className="relative overflow-hidden rounded-lg bg-[#F6F7FB] min-h-[403px]">
        ...
        <div className="text-center px-4 py-7.5 flex flex-col">
          <span className="text-dark">{item.category}</span>
          <h3 className="font-medium text-dark ease-out duration-200 hover:text-blue mb-1.5">
            <Link href="/shop-details"> {item.name} </Link>
          </h3>
          <span className="text-dark">{item.compound}</span>
          <span className="text-dark-4">{item.brand}</span>
        </div>
